        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            >
              ...
              <span className="font-display font-semibold text-xl">William Saunderson</span>
            </motion.div>
            
            <p className="text-slate-400 leading-relaxed mb-6 max-w-md">
              A passionate Software Engineering student at Belgium Campus ITVersity, dedicated to creating innovative solutions through code and technology.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3 text-slate-400">
              <li className="flex items-center space-x-3">
                ...
                <a href={`mailto:${personal.email}`} className="truncate hover:text-white transition-colors duration-200">
                  {personal.email}
                </a>
              </li>
              <li className="flex items-center space-x-3">
                ...
                <a href={`tel:${personal.phone}`} className="hover:text-white transition-colors duration-200">
                  {personal.phone}
                </a>
              </li>
              <li className="flex items-center space-x-3">
